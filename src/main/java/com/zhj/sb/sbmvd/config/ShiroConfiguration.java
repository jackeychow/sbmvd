/**
 * Filename ShiroConfiguration.java Create on 2018年10月10日 Copyright 2018 Jc All Rights Reserved.
 */
package com.zhj.sb.sbmvd.config;
...
import com.zhj.sb.sbmvd.realm.UserRealm;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shirFilter(org.apache.shiro.mgt.SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/student/loginAction", "anon");
        // <!-- authc:所有url都必须认证通过才可以访问; anon:所有url都都可以匿名访问-->
        filterChainDefinitionMap.put("/**", "authc");
        // 如果不设置默认会自动寻找Web工程根目录下的"/login.jsp"页面
        shiroFilterFactoryBean.setLoginUrl("/student/login");
        // 未授权界面;
